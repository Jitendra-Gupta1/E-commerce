...
<html>
    ...
    <body style="background-image: url(img/products/b3.jpg)">
                        ...
                        <div class="card-columns">
                            ...
                            <div class="card product-card">
                                ...
                                <div class="container text-center">
                                    <img src="img/products/<%= p.getpPhoto() %>" style="max-height: 200px; max-width: 100%; width: auto" class="Card image top m-2" >
                                </div>
                                
                                <div class="card-body">
                                    
                                    <h5 class="card-title m-2"><%= p.getpName() %></h5>
